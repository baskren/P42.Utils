...
namespace PCL.Utils
{
    ...
    public class MD5 : IDisposable
    {
        ...
        /// <param name="n"></param>
        /// <returns></returns>
        static uint ROTATE_LEFT(uint x, byte n)
        {
            return (((x) << (n)) | ((x) >> (32 - (n))));
        }
        #endregion
        ...
        /// <param name="count"></param>
        static void Encode(byte[] output, int outputOffset, uint[] input, int inputOffset, int count)
        {
            int i, j;
        ...
        /// <param name="inputOffset"></param>
        /// <param name="count"></param>
        static void Decode(uint[] output, int outputOffset, byte[] input, int inputOffset, int count)
        {
            int i, j;
