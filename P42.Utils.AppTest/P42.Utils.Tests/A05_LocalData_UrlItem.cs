...
public class A05_LocalData_UrlItem
{
    ...
    private static readonly LocalData.UriItem UriItem = LocalData.UriItem.For(SourceUri, RootUri);
    private static readonly LocalData.UriItem AltUriItem1 = LocalData.UriItem.For(SourceUri, new Uri("https://raw.githubusercontent.com/cbracco/html5-test-page/refs/heads"));
    private static readonly LocalData.UriItem AltUriItem2 = LocalData.UriItem.For(SourceUri, RootUri, "AltUris");
    private static readonly LocalData.UriItem AltUriItem3 = LocalData.UriItem.For(SourceUri, RootUri, assembly: typeof(P42.Utils.Uno.Platform).Assembly);


    [TestMethod]
    public void A01_KeyEquality()
    {
        var item = LocalData.UriItem.For(SourceUri, RootUri);
