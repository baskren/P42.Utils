...
#pragma warning restore Uno0001
            throw new ArgumentException($"UpdateSourceTrigger.Explicit and UpdateSourceTrigger.LostFocus are not supported in AltBinding. FilePath: [{_filePath}], LineNumber: [{_lineNumber}]");
