...
internal partial class HtmlDependencyObject : DependencyObject
{
    ...
    */
    ...
    private static List<string>? GetExcepts<T>(object? except)
    {
    ...
    internal static void SetAndFormatText(TextBlock textBlock, HtmlSpans newSpans, double altFontSize = -1)
    {
        ...
        */
        ...
        var baseMetaFont = new MetaFont(
            ...
            (textBlock.FontStyle & FontStyle.Italic) > 0,
        ...
        {
            Family = Platform.MathFontFamily //FontService.ReconcileFontFamily("Forms9Patch.Resources.Fonts.STIXGeneral.ttf", P42.Utils.AssemblyExtensions.CallerAssembly(typeof(Forms9Patch.Label)))
        };
