...
public static class TextBlockExtensions
{
    ...
    /// <param name="textBlock"></param>
    /// <returns></returns>
    public static string GetMarkdown(this ElementType textBlock)
    ...
    /// <param name="value"></param>
    /// <returns></returns>
    public static ElementType Markdown(this ElementType element, string value)
    { element.SetMarkdown(value); return element; }
