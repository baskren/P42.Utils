...
public static class MainThread
{
    ...
    public static void Init()
    {
        ...
        DispatchQueue = Microsoft.UI.Dispatching.DispatcherQueue.GetForCurrentThread();
    ...
    public static void Invoke(Action action)
    {
        ...
        if (!DispatchQueue.TryEnqueue(Microsoft.UI.Dispatching.DispatcherQueuePriority.Normal, action.Invoke))
    ...
    public static Task InvokeAsync(Action action)
    {
        ...
        return !DispatchQueue.TryEnqueue(
...
internal class NotInitializedException() : Exception("P42.Utils.Uno.MainThread not initialized via P42.Utils.Uno.MainThread.Init()");
