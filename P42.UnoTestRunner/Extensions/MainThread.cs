...
public static class MainThread
{
    ...
    public static bool IsMainThread
    {
        get
        {
            if (P42.UnoTestRunner.TestApplication.MainThreadDispatchQueue == null)
                throw new Exception("Unable to find main thread dispatch queue.  Did you call P42.Utils.Uno.Platform.Init() ?");

            return P42.UnoTestRunner.TestApplication.MainThread == Thread.CurrentThread;
        }
    }
    ...
    public static void Invoke(Action action)
    {
        ...
        if (!P42.UnoTestRunner.TestApplication.MainThreadDispatchQueue.TryEnqueue(Microsoft.UI.Dispatching.DispatcherQueuePriority.Normal, action.Invoke))
    ...
    public static Task InvokeAsync(Action action)
    {
        ...
        if (!P42.UnoTestRunner.TestApplication.MainThreadDispatchQueue.TryEnqueue(
