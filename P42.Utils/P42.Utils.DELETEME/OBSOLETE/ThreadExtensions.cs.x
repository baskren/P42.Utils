...
{
    [Obsolete("Use AsyncAwaitBestPractices instead")]
...
[Obsolete("Use AsyncAwaitBestPractices instead")]
public class FireAndForgetException(string callingMethodName, Exception innerException)
    : Exception($"Fire and forget task, from calling method [{callingMethodName}], failed.", innerException)
{
    /// <summary>
    /// Method that called the FireAndForget task
    /// </summary>
    public string CallingMethodName { get; private set; } = callingMethodName;
}
