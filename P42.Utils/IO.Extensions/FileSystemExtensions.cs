...
public static class FileSystemExtensions
{
    ...
    extension(FileSystemInfo fileSystemInfo)
    {
        ...
        private bool HasUnixWritePermission(bool checkParent = true)
        {
        ...
        private bool HasUnixReadPermission(bool checkParent = true)
        {
            if (!fileSystemInfo.Exists)
            {
                if (checkParent && fileSystemInfo.Parent is { } parent)
        ...
        private bool HasUnixExecutePermission(bool checkParent = true)
        {
            if (!fileSystemInfo.Exists)
            {
                if (checkParent && fileSystemInfo.Parent is { } parent)
        ...
        private bool HasWindowsWriteAccessControl(bool checkParent = true)
        {
            if (fileSystemInfo.Exists)
            {
...
#pragma warning disable CA1416
                    FileInfo fileInfo => fileInfo
                        ...
                        .Any(rule =>
                            rule.FileSystemRights.HasFlag(System.Security.AccessControl.FileSystemRights.WriteData)),
...
#pragma warning restore CA1416
        ...
        private bool HasWindowsReadAccessControl(bool checkParent = true)
        {
            if (fileSystemInfo.Exists)
            {
                return fileSystemInfo switch
...
#pragma warning disable CA1416
                    FileInfo fileInfo => fileInfo
                        ...
                        .OfType<System.Security.AccessControl.FileSystemAccessRule>()
                        .Any(rule =>
                            rule.FileSystemRights.HasFlag(System.Security.AccessControl.FileSystemRights.ReadData)),
                    DirectoryInfo directoryInfo => directoryInfo
                        .GetAccessControl()
                        .GetAccessRules(
                            true,
...
#pragma warning restore CA1416
        ...
        private bool HasWindowsExecuteAccessControl(bool checkParent = true)
        {
            if (fileSystemInfo.Exists)
            {
                return fileSystemInfo switch
...
#pragma warning disable CA1416
                    FileInfo fileInfo => fileInfo
                        ...
                        .OfType<System.Security.AccessControl.FileSystemAccessRule>()
                        .Any(rule =>
                            rule.FileSystemRights.HasFlag(System.Security.AccessControl.FileSystemRights.ExecuteFile)),
                    DirectoryInfo directoryInfo => directoryInfo
                        .GetAccessControl()
                        .GetAccessRules(
                            true,
