...
public static class LocalDataDirectoryInfoExtensions
{
    ...
    /// <param name="item"></param>
    /// <returns></returns>
    public static async Task<DirectoryInfo> AssureExistsDirectoryAsync(this AsynchronousSourcedItem item)
    {
    ...
    /// <param name="item"></param>
    /// <returns></returns>
    public static DirectoryInfo AssureExistsDirectory(this SynchronousSourcedItem item)
    {
        if (item is { Exists: true, IsDirectory: true })
            return item.Directory();
    ...
    /// <param name="item"></param>
    /// <returns></returns>
    public static async Task<DirectoryInfo?> TryAssureExistsDirectoryAsync(this AsynchronousSourcedItem item)
    {
        try
        {
    ...
    /// <param name="item"></param>
    /// <returns></returns>
    public static DirectoryInfo? TryAssureExistsDirectory(this SynchronousSourcedItem item)
    {
        try
        {
